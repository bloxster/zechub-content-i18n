...
- Antivirus: Disattivare durante la configurazione perché potrebbe segnalare i minatori come minacce.

## Guida passo-passo per unirsi a un pool di minatori
...
I pool di mining distribuiscono il lavoro e condividono le ricompense in base all'hashrate che hai versato. Scegli in base alle commissioni (0-2%), al pagamento minimo (0,01-0,1 ZEC), alla posizione (basso ping) e all'affidabilità.

**Pool consigliati (in base all'hashrate, alle commissioni e alle recensioni):**
...
- Per le GPU (esempio: lolMiner su Windows/Linux):
  ...
  4. Esegui il file batch. Si collegherà al pool e inizierà l'attività di mining.
- Per gli ASIC (esempio: Bitmain Antminer):
  1. Accedi alla dashboard web.
  2. Vai su Configurazione del minatore.
...
### Fase 5: Avvio dell'estrazione e monitoraggio
...
![Monitoraggio dell'estrazione di Zcash Setup](https://raw.githubusercontent.com/ZecHub/zechub/aac601cf85076960d334f4c841867a646a5a2f29/assets/images/zcashMining.jpg)
...
- **Nota ambientale:** L'estrazione mineraria consuma energia; se possibile, utilizza fonti rinnovabili.
